...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/bache.png',500,450, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png',550,250, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png',300,90, 30, 15, 1),
    new Obstaculo('imagenes/bache.png',800,450, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png',780,300, 30, 30, 1),
  ...
  enemigos: [new ZombieCaminante('imagenes/zombie1.png', 180, 230, 10, 10, 5,{
    desdeX:0,
    hastaX:961,
    desdeY:0,
    hastaY:577
  }),
  new ZombieCaminante('imagenes/zombie1.png', 100, 250, 10, 10, 5,{
    desdeX:0,
    hastaX:961,
    desdeY:0,
    hastaY:577
  }),
  new ZombieCaminante('imagenes/zombie3.png', 400, 100, 10, 10, 5,{
    desdeX:0,
    hastaX:961,
    desdeY:0,
    hastaY:577
  }),
  new ZombieCaminante('imagenes/zombie2.png', 100, 100, 10, 10, 5,{
    desdeX:0,
    hastaX:961,
    desdeY:0,
    hastaY:577
  }),
  new ZombieCaminante('imagenes/zombie2.png', 500, 100, 10, 10, 5,{
    desdeX:0,
    hastaX:961,
    desdeY:0,
    hastaY:577
  }),
  new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 3,{
    desdeX:0,
    hastaX:961,
    desdeY:0,
    hastaY:577
  ...
  new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 30, 3,{
    desdeX:0,
    hastaX:961,
    desdeY:0,
    hastaY:577
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo){
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      ...
      console.log("Le quedan ",this.jugador.vidas)
      puedeMoverse = false
    }
  }, this)
  return puedeMoverse
